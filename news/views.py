...
from django.db.models.functions import Power, Extract  # , Min, Now, Cast,
from django.db.models import Value, F, ExpressionWrapper, fields, Q, Min # Func
...
def _front_page(
    ...
    # Commented to check differences between postgresql and sqlite
