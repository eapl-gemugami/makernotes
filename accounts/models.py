...
class CustomUser(AbstractUser, MPTTModel):
    ...
    def get_absolute_url(self) -> str:  # pylint: disable=missing-method-docstring
        return reverse("accounts_profile", kwargs={"username": self.username})

    @property  # pylint: disable=missing-method-docstring
...
class EmailVerification(models.Model):
    ...
    def get_verify_url(self):
        return reverse(
            "accounts_verify", kwargs={"verification_code": self.verification_code}
        )
...
class PasswordResetRequest(models.Model):
    ...
    def get_verify_url(self):
        return reverse(
            "password_forgotten", kwargs={"verification_code": self.verification_code}
        )
